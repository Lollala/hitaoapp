...
public class MsgUtil {
	...
	public static SendSmsResponse sendMsg(String mobile,int value) throws Exception {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI5bvXfH4g0bl3";//你的accessKeyId
        final String accessKeySecret = "ZeSukVfFGNDZij1xekGZj5cembKUm2";//你的accessKeySecret
        ...
        //必填:短信签名
        request.setSignName("樱红");  // 短信签名，必须在短信控制台中开通(需要2个小时的审核时间)
        //必填:短信模板
        request.setTemplateCode("SMS_145599593"); //短信 模板，必须在短信控制台开通
